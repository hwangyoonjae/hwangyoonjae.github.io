...
## 1. LVM(Logical Volume Manager)란? :
- 논리 볼륨 관리자라는 뜻으로, 우리가 사용하는 물리적인 디스크 여러개를 논리적인 디스크로 할당하여 유연하게 관리할 수 있게 해주는 기능입니다.
- Linux 환경에서 저장 공간(=하드 디스크)를 효과적으로 관리하기 위해 제공하는 제공되는 커널 기능입니다.

* * *

### 1.1 LVM(Logical Volume Manager)의 장점 :
- 디스크 공간을 쉽게 확장할 수 있습니다.
- 여러 개의 디스크 공간을 합쳐서 하나처럼 사용할 수 있습니다.

* * *

## 2. LVM(Logical Volume Manager) 관련 용어 및 구성 :
...
* 볼륨 그룹 / VG(Volume Group)
  ...
  - 사용자는 VG를 원하는대로 쪼개서 LV로 만들게 됩니다.
...
## 3. LVM(Logical Volume Manager) 작업 순서 :
