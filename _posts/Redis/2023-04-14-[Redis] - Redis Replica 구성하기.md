...
```
![Redis Master 재시작](/assets/img/post/Redis/Redis%20Master%20%EC%9E%AC%EC%8B%9C%EC%9E%91%20%EA%B2%B0%EA%B3%BC.PNG)
...
```
![Redis Master 데이터 입력](/assets/img/post/Redis/Redis%20Master%20%EB%8D%B0%EC%9D%B4%ED%84%B0%20%EC%9E%85%EB%A0%A5.PNG)
...
$ redis-cli -a "Redis에서 설정한 암호"
```
![Redis Slave 데이터 출력](/assets/img/post/Redis/Redis%20Slave%20%EB%8D%B0%EC%9D%B4%ED%84%B0%20%EC%B6%9C%EB%A0%A5.PNG)
