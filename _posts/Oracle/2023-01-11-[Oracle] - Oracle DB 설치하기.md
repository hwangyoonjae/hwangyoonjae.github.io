...
## 1. Oralce이란? :
- 미국의 기업에서 만든 데이터 베이스 관리 시스템이며, 관계형 데이터베이스의 한 종류입니다.

* * *

## 2. Oracle DB 설치 준비하기 :
### 2.1 Oracle 19c 파일을 다운로드 :
- 아래 URL 참고하여 oracle 설치파일과 설치 시 추가로 필요한 rpm파일까지 다운받습니다.
...
### 2.5 Oracle 19c 설치하기 :
- 위에서 진행한 oracle 19c 설치파일을 옮겨서 설치합니다.
...
- 오라클사 홈페이지에서 다운로드 받은 압축 파일을 해제 후 인스톨러 실행합니다.
...
- /etc/oraInst.loc 파일 열어 inst_group을 변경합니다.
