...
## 1. Kubernetes Docker 지원 중단 :
- Kubernetes에서 V1.20.0이후부터 Docker 지원 중단되어 Docker는 설치하지 않고 진행합니다.

* * *

## 2. Kubernetes 설치 전 준비사항 :
### 2.1 Containerd 설치하기 :
- Kubernetes Pod에서 컨테이너를 실행하기 위해 설치합니다.
...
### 3.1 Selinux permissive 모드로 변경하기 :
...
### 3.4 br_netfilter활성화 & iptables 설정하기 :
...
## 4. Kubernetes 설치하기 :
### 4.1 kubernetes YUM Repository 설정하기 :
...
### 4.3  Flannel 설치하기 :
- 서로 다른 노드에 있는 pod 간 통신을 완성하기 위해서 network plugin인 Flannel을 설치합니다.
