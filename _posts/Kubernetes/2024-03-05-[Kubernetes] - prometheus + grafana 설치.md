...
```
![grafana 패스워드 입력](/assets/img/post/kubernetes/grafana%20패스워드%20입력.png)
...
```
![prometheus 설치 완료](/assets/img/post/kubernetes/prometheus%20설치%20완료.png)
...
```
![prometheus,grafana pod 확인](/assets/img/post/kubernetes/prometheus,grafana%20pod%20확인.png)
...
```
![prometheus,grafana service 확인](/assets/img/post/kubernetes/prometheus,grafana%20service%20확인.png)
...
```
![grafana 외부 접속 포트 설정](/assets/img/post/kubernetes/grafana%20외부%20접속%20포트%20설정.png)
...
```
![prometheus 외부 접속 포트 설정](/assets/img/post/kubernetes/prometheus%20외부%20접속%20포트%20설정.png)
