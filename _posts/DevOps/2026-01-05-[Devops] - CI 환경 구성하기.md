...
|        Key          |  Value  |  설명   |
|:-------------------:|:-------:|:---------------:|
| CI_CA_CERT          | ```pem<br>-----BEGIN CERTIFICATE-----<br>MIIFhzCC...<br>-----END CERTIFICATE-----``` | <ROOT_CA.CRT> |
...
| MANIFEST_REPO_TOKEN | glpat-gQ4KNJFzkySysYzmemZi8m86MQp1OjcH.01.0w1p0y1sd | <GITLAB_ACCESS_TOKEN> |
| MANIFEST_REPO_URL   | gitlab.test.com   | <GITLAB_URL>          |
| MANIFEST_REPO_USER  | root | <GITLAB_USERNAME>     |
| NEXUS_MIRROR_URL    | nexus.test.com | <NEXUS_REPO_URL>      |
